...
function useCallbackRef3(fn, deps = []) {
  const ref = (0, import_react54.useRef)(fn);
...
function usePopper(props = {}) {
  ...
  const reference = (0, import_react88.useRef)(null);
  const popper = (0, import_react88.useRef)(null);
