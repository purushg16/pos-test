...
var Fit = (
  ...
  function(_super) {
    ...
    Fit2.propTypes = {
      ...
      invertAxis: import_prop_types4.default.bool,
      invertSecondaryAxis: import_prop_types4.default.bool,
      mainAxis: import_prop_types4.default.oneOf(["x", "y"]),
      spacing: import_prop_types4.default.oneOfType([
...
var allValueTypes2 = __spreadArray7(__spreadArray7([], allViews3.slice(1), true), ["day"], false);
...
var allValueTypes3 = __spreadArray8(__spreadArray8([], allViews4.slice(1), true), ["day"], false);
var isValueType = import_prop_types5.default.oneOf(allValueTypes3);
...
var isRef2 = import_prop_types5.default.oneOfType([
  import_prop_types5.default.func,
  import_prop_types5.default.exact({
    current: import_prop_types5.default.any
  })
]);
var rangeOf2 = function(type) {
  return import_prop_types5.default.arrayOf(type);
};
...
var isValue3 = import_prop_types6.default.oneOfType([import_prop_types6.default.string, import_prop_types6.default.instanceOf(Date)]);
var isValueOrValueArray2 = import_prop_types6.default.oneOfType([isValue3, rangeOf2(isValue3)]);
DatePicker.propTypes = {
  autoFocus: import_prop_types6.default.bool,
  calendarAriaLabel: import_prop_types6.default.string,
  calendarClassName: import_prop_types6.default.oneOfType([import_prop_types6.default.string, import_prop_types6.default.arrayOf(import_prop_types6.default.string)]),
  calendarIcon: import_prop_types6.default.oneOfType([import_prop_types6.default.node, import_prop_types6.default.func]),
  className: import_prop_types6.default.oneOfType([import_prop_types6.default.string, import_prop_types6.default.arrayOf(import_prop_types6.default.string)]),
  clearAriaLabel: import_prop_types6.default.string,
  clearIcon: import_prop_types6.default.oneOfType([import_prop_types6.default.node, import_prop_types6.default.func]),
  closeCalendar: import_prop_types6.default.bool,
  "data-testid": import_prop_types6.default.string,
  dayAriaLabel: import_prop_types6.default.string,
  dayPlaceholder: import_prop_types6.default.string,
  disableCalendar: import_prop_types6.default.bool,
  disabled: import_prop_types6.default.bool,
  format: import_prop_types6.default.string,
  id: import_prop_types6.default.string,
  isOpen: import_prop_types6.default.bool,
  locale: import_prop_types6.default.string,
  maxDate: isMaxDate3,
  maxDetail: import_prop_types6.default.oneOf(allViews5),
  minDate: isMinDate3,
  monthAriaLabel: import_prop_types6.default.string,
  monthPlaceholder: import_prop_types6.default.string,
  name: import_prop_types6.default.string,
  nativeInputAriaLabel: import_prop_types6.default.string,
  onCalendarClose: import_prop_types6.default.func,
  onCalendarOpen: import_prop_types6.default.func,
  onChange: import_prop_types6.default.func,
  onFocus: import_prop_types6.default.func,
  openCalendarOnFocus: import_prop_types6.default.bool,
  required: import_prop_types6.default.bool,
  returnValue: import_prop_types6.default.oneOf(["start", "end", "range"]),
  showLeadingZeros: import_prop_types6.default.bool,
  value: isValueOrValueArray2,
  yearAriaLabel: import_prop_types6.default.string,
  yearPlaceholder: import_prop_types6.default.string
};
if (isBrowser3) {
  DatePicker.propTypes.portalContainer = import_prop_types6.default.instanceOf(HTMLElement);
}
